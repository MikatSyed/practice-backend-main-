...
router.patch('/:id', (0, validateRequest_1.default)(services_validate_1.ServiceValidation.updateServiceZodSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), service_controller_1.ServiceController.updateOneInDB);
router.delete('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), service_controller_1.ServiceController.deleteByIdFromDB);
